--隐射一次配置表中的type
SkillEventType = { }
SkillEventType.Lock = 0
SkillEventType.Anim = 2
SkillEventType.Audio = 3
...
SkillEventTypeLang[SkillEventType.Anim] = 'Anim'
SkillEventTypeLang[SkillEventType.Audio] = 'Audio'
